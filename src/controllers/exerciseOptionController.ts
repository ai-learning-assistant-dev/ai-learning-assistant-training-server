...
export class ExerciseOptionController extends BaseController {
  @Post('/search')
  public async searchExerciseOptions(@Body() body: { page?: number; limit?: number }): Promise<ApiResponse<ExerciseOptionResponse[]>> {
    try {
  ...
  @Post('/getById')
  public async getExerciseOptionById(@Body() body: { option_id: string }): Promise<ApiResponse<ExerciseOptionResponse>> {
    try {
      const repo = MainDataSource.getRepository(ExerciseOption);
  ...
  @Post('/add')
  public async addExerciseOption(@Body() requestBody: CreateExerciseOptionRequest): Promise<ApiResponse<any>> {
    try {
  ...
  @Post('/update')
  public async updateExerciseOption(@Body() requestBody: UpdateExerciseOptionRequest): Promise<ApiResponse<any>> {
    try {
  ...
  @Post('/delete')
  public async deleteExerciseOption(@Body() body: { option_id: string }): Promise<ApiResponse<any>> {
    try {
      const repo = MainDataSource.getRepository(ExerciseOption);
