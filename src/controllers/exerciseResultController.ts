...
export class ExerciseResultController extends BaseController {
  ...
  public async getExerciseResults(@Body() body: { user_id: string; section_id: string | null; test_result_id?: string | null }): Promise<ApiResponse<any>> {
    try {
  ...
  @Post('/search')
  public async searchExerciseResults(@Body() body: { page?: number; limit?: number }): Promise<ApiResponse<ExerciseResult[]>> {
    try {
  ...
  @Post('/getById')
  public async getExerciseResultById(@Body() body: { result_id: string }): Promise<ApiResponse<ExerciseResult>> {
    try {
      const repo = UserDataSource.getRepository(ExerciseResult);
  ...
  @Post('/add')
  public async addExerciseResult(@Body() requestBody: Partial<ExerciseResult>): Promise<ApiResponse<any>> {
    try {
  ...
  @Post('/update')
  public async updateExerciseResult(@Body() requestBody: Partial<ExerciseResult>): Promise<ApiResponse<any>> {
    try {
  ...
  @Post('/delete')
  public async deleteExerciseResult(@Body() body: { result_id: string }): Promise<ApiResponse<any>> {
    try {
      const repo = UserDataSource.getRepository(ExerciseResult);
      const item = await repo.findOneBy({ result_id: body.result_id });
      if (!item) {
