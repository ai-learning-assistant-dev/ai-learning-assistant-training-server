...
export class LearningRecordController extends BaseController {
  @Post('/search')
  public async searchLearningRecords(
  ...
  @Post('/add')
  public async addLearningRecord(
    @Body() requestBody: CreateLearningRecordRequest
  ...
  @Post('/update')
  public async updateLearningRecord(
    @Body() requestBody: UpdateLearningRecordRequest
  ): Promise<ApiResponse<any>> {
    try {
